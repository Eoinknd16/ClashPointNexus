...
const api: LauncherApi = {
  ...
  stremio: {
    ...
    getExtendedMeta: (type, id) => ipcRenderer.invoke('stremio:getExtendedMeta', type, id),
  ...
  settings: {
    ...
    getOmdbApiKey: () => ipcRenderer.invoke('settings:getOmdbApiKey'),
    setOmdbApiKey: (key) => ipcRenderer.invoke('settings:setOmdbApiKey', key),
  ...
  globalInput: {
    ...
    goToDesktop: () => ipcRenderer.invoke('globalInput:goToDesktop'),
