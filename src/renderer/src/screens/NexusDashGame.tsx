 ...
 *
 * Reached from the Arcade hub's own "Nexus Dash" tile (ArcadeScreen.tsx) —
 * onExit returns there rather than this component knowing about Home/
 * navigation at all, so it stays a self-contained game screen.
 *
 ...
 * for the HUD text.
 */
export function NexusDashGame({ onExit }: { onExit: () => void }): JSX.Element {
